...
# - Tuned Block Sizes for modern GPUs (A100/H100/3090)
...
def fused_backward_weight(
    ...
    # Tuning config (Aggressive settings for A100/H100/3090)
    # BLOCK_M/N = 128 is usually sweet spot for modern GPUs
    BLOCK_M = 128
    BLOCK_N = 128
    BLOCK_K = 32  # Smaller K to increase parallelism inside dot
    GROUP_SIZE_M = 8  # Critical for L2 Cache hit rate
    
    # Calculate grid based on 1D launch for L2 Cache Swizzling
    grid = lambda META: (
