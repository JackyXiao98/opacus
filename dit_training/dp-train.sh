...
NOISE_MULTIPLIER=0.3701
GRAD_SAMPLE_MODE=flash
DATA_PATH=/mnt/bn/watermark/split_volume/zhaoyuchen/Project/ffhq-dataset/images1024x1024-onedic
RESULT_PATH=/mnt/bn/watermark/split_volume/zhaoyuchen/Dataset/dit-results/Test-dp-$MODEL-$PATCH-img$IMAGE_SIZE-cls$NUM_CLASS-bs$GLOBAL_BATCH_SIZE-noise$NOISE_MULTIPLIER-$GRAD_SAMPLE_MODE-ffhq
echo $RESULT_PATH
...
nohup torchrun --nnodes=$ARNOLD_WORKER_NUM \
        ...
        --log_every 100 \
        > ./output-dp-$GRAD_SAMPLE_MODE-test.log 2>&1 &
