...
if __name__ == '__main__':
    img1_root = '/mnt/bn/watermark/split_volume/zhaoyuchen/Project/ffhq-dataset/images1024x1024-fid10k'
    img_roots = [
        "/mnt/bn/watermark/split_volume/zhaoyuchen/Dataset/dit-results/dp-DiT-B-4-img512-cls1-bs256-noise0-flash_bk-ffhq/000-DiT-B-4/checkpoints/DiT-B-4-0100000-size-512-vae-ema-cfg-1-seed-0",
        "/mnt/bn/watermark/split_volume/zhaoyuchen/Dataset/dit-results/dp-DiT-B-4-img512-cls1-bs256-noise0-flash_bk-ffhq/000-DiT-B-4/checkpoints/DiT-B-4-0050000-size-512-vae-ema-cfg-1-seed-0"
    ]
